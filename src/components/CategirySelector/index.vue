<template>
  <el-form inline>
      <el-form-item label="一级分类" type="primary">
        <el-select v-model="category1Id" placeholder="请选择" :disabled="isDisable">
          <el-option
      ...
      <el-form-item label="二级分类">
        <el-select v-model="category2Id" placeholder="请选择" :disabled="isDisable">
          <el-option
      ...
      <el-form-item label="三级分类">
        <el-select v-model="categoryStore.category3Id" placeholder="请选择" :disabled="isDisable">
          <el-option
